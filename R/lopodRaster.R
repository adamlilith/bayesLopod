...
#' @param metric metric "Rhat", "mean", or "sd". Plots the Rhat, mean or standard deviation of the posterior distribution. If NULL, the value in quant is used.
...
#' @return A \linkS4class{Raster} object.
#' @export
#' @examples
